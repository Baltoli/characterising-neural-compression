...
int im_sizes[27] = {224, 224, 16, 16, 16, 16, 8, 8, 8, 8, 4, 4, 4, 4,
...
int mem_block_shape[3] = {
    1024, 224,
    224};  // allocate the absolute maximum amount of space we will need
float ***block1;
float ***block2;
...
/* // ORIGINAL FISHER EXPERIMENTS
        int cshape[27][4] = {
                { 224,  3, CONV_SIZE, CONV_SIZE },
                { 224,  1, CONV_SIZE, CONV_SIZE },
          { 43, 224, 1, 1 },
...
int cshape[27][4] = {{224, 3, CONV_SIZE, CONV_SIZE},
                     {224, 1, CONV_SIZE, CONV_SIZE},
                     {43, 224, 1, 1},
                     {43, 1, CONV_SIZE, CONV_SIZE},
                     {85, 43, 1, 1},
