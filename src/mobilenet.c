...
int im_sizes[27] = {32, 32, 16, 16, 16, 16, 8, 8, 8, 8, 4, 4, 4, 4,
...
int mem_block_shape[3] = {
    1024, 32,
    32};  // allocate the absolute maximum amount of space we will need
float ***block1;
float ***block2;
...
int cshape[27][4] = {{32, 3, CONV_SIZE, CONV_SIZE},
                     {32, 1, CONV_SIZE, CONV_SIZE},
                     {43, 32, 1, 1},
                     {43, 1, CONV_SIZE, CONV_SIZE},
                     {85, 43, 1, 1},
