...
int im_sizes[27] = {64, 64, 16, 16, 16, 16, 8, 8, 8, 8, 4, 4, 4, 4,
...
int mem_block_shape[3] = {
    1024, 64,
    64};  // allocate the absolute maximum amount of space we will need
float ***block1;
float ***block2;
...
int cshape[27][4] = {{64, 3, CONV_SIZE, CONV_SIZE},
                     {64, 1, CONV_SIZE, CONV_SIZE},
                     {43, 64, 1, 1},
                     {43, 1, CONV_SIZE, CONV_SIZE},
                     {85, 43, 1, 1},
